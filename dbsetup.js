...
/* product 테이블의 더미 데이터 */
// INSERT INTO `product`(`product_id`, `product`, `type_avail`, `info`, `price`, `user_id`, `rating`, `quantity`, `category`) VALUES (1, "Porstina - Embroidered Zip Jacket", "Black,White", "Oversized jacket accented with durable metallic zipper at the center front and minimal embroidery ooze streetwear vibes. Its drop-shoulder cut is accentuated with cinched elastic cuffs and roomy welt pockets. Available in a range of sizes.", 23356, "Porstina", "4.6", 57, "Clothing");
//
...
//
// INSERT INTO `product`(`product_id`, `product`, `type_avail`, `info`, `price`, `user_id`, `rating`, `quantity`, `category`) VALUES (3, "Carryme - Set: Lightweight Backpack + Pouch", "Green,Khaki", "This pretty drawstring bag has a perfect size for transporting man's or woman's swim gear or PE kit or other essentials for the gym, school and other short trips. Put it on your back and you won't even notice it's there when out on short excursions or bike trips..", 54208, "Trencur", "5.0", 20, "Bags");
//
// INSERT INTO `product`(`product_id`, `product`, `type_avail`, `info`, `price`, `user_id`, `rating`, `quantity`, `category`) VALUES (4, "Aisyi - Blue Light Blocking Glasses", "Red,Gold,Brown", "As practical as they’re stylish, these black-rimmed glasses with thin but study frames are fitted with blue light blocking technology to protect the eyes. Perfect for long days in front of the computer as well as for quick pre-bedtime peeks at your phone!", 14372, "Trencur", "2.6", 192, "Accessories");
